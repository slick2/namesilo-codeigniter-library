...
class Namesilo {
    ...
    public function __construct() {
        ...
        $this->load->config('namesilo', TRUE);

        if ($this->config->item('development', 'namesilo')) {
            $this->url = $this->config->item('url_sandbox', 'namesilo');
            $this->key = $this->config->item('key_sandbox', 'namesilo');
        } else {
            $this->url = $this->config->item('url', 'namesilo');
            $this->key = $this->config->item('key', 'namesilo');
        }
    }
